...
function Modal() {
    ...
    const uploadPost = async() => {
        ...
        //Upload the image to firebase storage wit the post ID
        const imageRef = ref(storage, `posts/${docRef.id}/image`)

        //Get the downloadUrl from fb storage and upload to original post
                    ...
                    >
                      ...
                      <div className='inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-0 sm:align-middle sm:max-w-sm sm:w-full sm:p-6'>
                          <div>
                            ...
                            {
                              selectedFile ? (
                                  <img src={selectedFile} className='w-full object-contain cursor-pointer' alt="contentImage" onClick={() =>  setSelectedFile(null)} />
                              )
                              : (
                                <div
